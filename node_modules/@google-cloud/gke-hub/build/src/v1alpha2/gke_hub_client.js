...
class GkeHubClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createMembershipResponse = protoFilesRoot.lookup('.google.cloud.gkehub.v1alpha2.Membership');
        const createMembershipMetadata = protoFilesRoot.lookup('.google.cloud.gkehub.v1alpha2.OperationMetadata');
        const deleteMembershipResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteMembershipMetadata = protoFilesRoot.lookup('.google.cloud.gkehub.v1alpha2.OperationMetadata');
        const updateMembershipResponse = protoFilesRoot.lookup('.google.cloud.gkehub.v1alpha2.Membership');
        const updateMembershipMetadata = protoFilesRoot.lookup('.google.cloud.gkehub.v1alpha2.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.gkehub.v1alpha2.GkeHub', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.gkeHubStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.gkehub.v1alpha2.GkeHub')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.gkehub.v1alpha2.GkeHub, this._opts, this._providedCustomServicePath);
    ...
    initializeHub(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {

...
class GkeHubClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createFeatureResponse = protoFilesRoot.lookup('.google.cloud.gkehub.v1beta.Feature');
        const createFeatureMetadata = protoFilesRoot.lookup('.google.cloud.gkehub.v1beta.OperationMetadata');
        const deleteFeatureResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteFeatureMetadata = protoFilesRoot.lookup('.google.cloud.gkehub.v1beta.OperationMetadata');
        const updateFeatureResponse = protoFilesRoot.lookup('.google.cloud.gkehub.v1beta.Feature');
        const updateFeatureMetadata = protoFilesRoot.lookup('.google.cloud.gkehub.v1beta.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.gkehub.v1beta.GkeHub', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.gkeHubStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.gkehub.v1beta.GkeHub')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.gkehub.v1beta.GkeHub, this._opts, this._providedCustomServicePath);

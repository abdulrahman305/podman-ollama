 ...
 */
const gapicConfig = require("./gke_hub_client_config.json");
...
class GkeHubClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            featurePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/features/{feature}'),
        ...
        this.descriptors.page = {
            listMemberships: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'resources'),
            listFeatures: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'resources'),
        };
        ...
        const createMembershipResponse = protoFilesRoot.lookup('.google.cloud.gkehub.v1.Membership');
        const createMembershipMetadata = protoFilesRoot.lookup('.google.cloud.gkehub.v1.OperationMetadata');
        const createFeatureResponse = protoFilesRoot.lookup('.google.cloud.gkehub.v1.Feature');
        const createFeatureMetadata = protoFilesRoot.lookup('.google.cloud.gkehub.v1.OperationMetadata');
        const deleteMembershipResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteMembershipMetadata = protoFilesRoot.lookup('.google.cloud.gkehub.v1.OperationMetadata');
        const deleteFeatureResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteFeatureMetadata = protoFilesRoot.lookup('.google.cloud.gkehub.v1.OperationMetadata');
        const updateMembershipResponse = protoFilesRoot.lookup('.google.cloud.gkehub.v1.Membership');
        const updateMembershipMetadata = protoFilesRoot.lookup('.google.cloud.gkehub.v1.OperationMetadata');
        const updateFeatureResponse = protoFilesRoot.lookup('.google.cloud.gkehub.v1.Feature');
        const updateFeatureMetadata = protoFilesRoot.lookup('.google.cloud.gkehub.v1.OperationMetadata');
        this.descriptors.longrunning = {
            createMembership: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createMembershipResponse.decode.bind(createMembershipResponse), createMembershipMetadata.decode.bind(createMembershipMetadata)),
            ...
            deleteMembership: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteMembershipResponse.decode.bind(deleteMembershipResponse), deleteMembershipMetadata.decode.bind(deleteMembershipMetadata)),
            ...
            updateMembership: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateMembershipResponse.decode.bind(updateMembershipResponse), updateMembershipMetadata.decode.bind(updateMembershipMetadata)),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.gkehub.v1.GkeHub', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.gkeHubStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.gkehub.v1.GkeHub')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.gkehub.v1.GkeHub, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of gkeHubStubMethods) {
            const callPromise = this.gkeHubStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    generateConnectManifest(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCreateMembershipProgress(name) {
     ...
     */
    async checkDeleteMembershipProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     */
    async checkUpdateMembershipProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
...
exports.GkeHubClient = GkeHubClient;
//# sourceMappingURL=gke_hub_client.js.map
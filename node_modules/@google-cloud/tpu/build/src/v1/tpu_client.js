...
class TpuClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            tensorFlowVersionPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/tensorFlowVersions/{tensor_flow_version}'),
        };
        ...
        this.descriptors.page = {
            ...
            listTensorFlowVersions: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'tensorflowVersions'),
        ...
        const createNodeResponse = protoFilesRoot.lookup('.google.cloud.tpu.v1.Node');
        const createNodeMetadata = protoFilesRoot.lookup('.google.cloud.tpu.v1.OperationMetadata');
        const deleteNodeResponse = protoFilesRoot.lookup('.google.cloud.tpu.v1.Node');
        const deleteNodeMetadata = protoFilesRoot.lookup('.google.cloud.tpu.v1.OperationMetadata');
        const reimageNodeResponse = protoFilesRoot.lookup('.google.cloud.tpu.v1.Node');
        const reimageNodeMetadata = protoFilesRoot.lookup('.google.cloud.tpu.v1.OperationMetadata');
        const stopNodeResponse = protoFilesRoot.lookup('.google.cloud.tpu.v1.Node');
        const stopNodeMetadata = protoFilesRoot.lookup('.google.cloud.tpu.v1.OperationMetadata');
        const startNodeResponse = protoFilesRoot.lookup('.google.cloud.tpu.v1.Node');
        const startNodeMetadata = protoFilesRoot.lookup('.google.cloud.tpu.v1.OperationMetadata');
        this.descriptors.longrunning = {
            ...
            reimageNode: new this._gaxModule.LongrunningDescriptor(this.operationsClient, reimageNodeResponse.decode.bind(reimageNodeResponse), reimageNodeMetadata.decode.bind(reimageNodeMetadata)),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.tpu.v1.Tpu', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.tpuStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.tpu.v1.Tpu')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.tpu.v1.Tpu, this._opts, this._providedCustomServicePath);
    ...
    getTensorFlowVersion(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    reimageNode(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkReimageNodeProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listTensorFlowVersions(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listTensorFlowVersionsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTensorFlowVersions.createStream(this.innerApiCalls.listTensorFlowVersions, request, callSettings);
    }
    /**
    ...
    listTensorFlowVersionsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTensorFlowVersions.asyncIterate(this.innerApiCalls['listTensorFlowVersions'], request, callSettings);
    }

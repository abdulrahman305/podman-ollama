...
class TpuClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createNodeResponse = protoFilesRoot.lookup('.google.cloud.tpu.v2.Node');
        const createNodeMetadata = protoFilesRoot.lookup('.google.cloud.tpu.v2.OperationMetadata');
        const deleteNodeResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteNodeMetadata = protoFilesRoot.lookup('.google.cloud.tpu.v2.OperationMetadata');
        const stopNodeResponse = protoFilesRoot.lookup('.google.cloud.tpu.v2.Node');
        const stopNodeMetadata = protoFilesRoot.lookup('.google.cloud.tpu.v2.OperationMetadata');
        const startNodeResponse = protoFilesRoot.lookup('.google.cloud.tpu.v2.Node');
        const startNodeMetadata = protoFilesRoot.lookup('.google.cloud.tpu.v2.OperationMetadata');
        const updateNodeResponse = protoFilesRoot.lookup('.google.cloud.tpu.v2.Node');
        const updateNodeMetadata = protoFilesRoot.lookup('.google.cloud.tpu.v2.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.tpu.v2.Tpu', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.tpuStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.tpu.v2.Tpu')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.tpu.v2.Tpu, this._opts, this._providedCustomServicePath);
